...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "OpenCheck" },
      { property: "og:title", content: "OpenCheck — Free, privacy-focused plagiarism checker" },
      {
        property: "og:description",
        content:
          "A free similarity checker for students, writers, and researchers. Similarity is an indicator, not a verdict.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "google-site-verification",
        content: "GQJzAu38cOSgKGEt9t0CsUJZaAASZordq0iiYv24qCA",
      },
    ],
    links: [
      {
